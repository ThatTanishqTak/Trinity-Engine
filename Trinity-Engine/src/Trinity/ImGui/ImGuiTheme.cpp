...
namespace Trinity
{
    ...
    void ImGuiTheme::SetDarkTheme()
    {
        ...
        colors[ImGuiCol_CheckMark] = ImVec4(0.47f, 0.77f, 0.47f, 1.00f);
        colors[ImGuiCol_SliderGrab] = ImVec4(0.47f, 0.77f, 0.47f, 1.00f);
        colors[ImGuiCol_SliderGrabActive] = ImVec4(0.60f, 0.90f, 0.60f, 1.00f);
        ...
        colors[ImGuiCol_ResizeGrip] = ImVec4(0.25f, 0.25f, 0.25f, 0.60f);
        colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.40f, 0.40f, 0.40f, 0.80f);
        ...
        colors[ImGuiCol_TabSelectedOverline] = ImVec4(0.47f, 0.77f, 0.47f, 1.00f);
        colors[ImGuiCol_TabDimmed] = ImVec4(0.08f, 0.08f, 0.08f, 1.00f);
        colors[ImGuiCol_TabDimmedSelected] = ImVec4(0.14f, 0.14f, 0.14f, 1.00f);
        colors[ImGuiCol_DockingPreview] = ImVec4(0.47f, 0.77f, 0.47f, 0.50f);
        colors[ImGuiCol_DockingEmptyBg] = ImVec4(0.08f, 0.08f, 0.08f, 1.00f);
        colors[ImGuiCol_PlotLines] = ImVec4(0.55f, 0.55f, 0.55f, 1.00f);
        colors[ImGuiCol_PlotLinesHovered] = ImVec4(0.47f, 0.77f, 0.47f, 1.00f);
        colors[ImGuiCol_PlotHistogram] = ImVec4(0.47f, 0.77f, 0.47f, 1.00f);
        colors[ImGuiCol_PlotHistogramHovered] = ImVec4(0.60f, 0.90f, 0.60f, 1.00f);
        colors[ImGuiCol_TextSelectedBg] = ImVec4(0.30f, 0.50f, 0.30f, 0.50f);
        colors[ImGuiCol_DragDropTarget] = ImVec4(0.47f, 0.77f, 0.47f, 0.90f);
        colors[ImGuiCol_NavCursor] = ImVec4(0.47f, 0.77f, 0.47f, 1.00f);
