...
namespace Trinity
{
    ...
    bool SkyboxStage::Initialize(GraphicsDevice& device, ShaderCompiler& compiler, const std::filesystem::path& shaderDirectory, Format colorFormat, Format depthFormat)
    {
        ...
        {
            TR_CORE_ERROR("SkyboxStage: shader compilation failed");
        ...
        {
            TR_CORE_ERROR("SkyboxStage: shader creation failed");
            Shutdown();
        ...
        {
            TR_CORE_ERROR("SkyboxStage: pipeline creation failed");
            Shutdown();
        ...
        {
            TR_CORE_ERROR("SkyboxStage: sampler creation failed");
            Shutdown();

            return false;
        }

        TR_CORE_INFO("SkyboxStage: initialized");
